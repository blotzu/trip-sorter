...
/**
 * The TrainCard unit test class
 */
class TrainCardTests extends TestCase  
{
	/**
    ...
    {
    	$card = new TrainCard($source = "Source", $target = "Target", $vehicleNumber = "ABC");
    ...
    public function test_Contructor_VehicleNumber_Missing(): void
    {
    	...
    	new TrainCard($source = "Source", $target = "Target");
    }
    ...
    public function test_Constructor_VehicleNumber_EmptyString(): void
    {
    	...
    	new TrainCard($source = "Source", $target = "Target", $vehicleNumber = "");
    }
    ...
    {
    	$card = new TrainCard($source = "Source", $target = "Target", $vehicleNumber = "AB1");
    	$card->setSeatNumber("123");

		$this->assertEquals("Take train AB1 from Source to Target. Sit in seat 123.", $card->getTripDescription(), "Incorrect trip description");
    }
    ...
    public function test_GetTripDescription_NoSeatNumber(): void
    {
		...
		$this->assertEquals("Take train AB1 from Source to Target. No seat assignment.", $card->getTripDescription(), "Incorrect trip description");
    }
}